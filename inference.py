...
def _sample_top_p(probs:torch.Tensor,p:float):
    ...
    # Zero out all the probilities of tokens that are not selected by the Top P
    probs_sort[mask]=0.0
    # Redistribute the probilities so that they sum up to 1
...
def test_inference(
    ...
    # Genearte the tokens until you see the stop token
    ...
    decoded=processor.tokenizer.decode(generate_tokens,skip_special_tokens=True)
